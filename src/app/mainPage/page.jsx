        ...
        <>
            ...
            <div className='flex flex-col justify-center items-center '>
                ...
                <div className='relative   W-full '>
                    ...
                    <div className=' absolute bottom-0 left-0 z-50 bg-gradient-to-r from-purple-500 to-pink-500 shadow-2xl h-24 w-full  text-center '>
                        <div className='flex justify-center items-center text-center gap-6 mt-7 '>

                            <Link href="/goal">
                                <button className='w-24 h-10 rounded-full bg-pink-500 p-2'>
                                    پنل کاربری
                                </button>
                            </Link>

                            <div className='w-24 h-10 rounded-full bg-pink-500 p-2'>
                                خانه
                            </div>

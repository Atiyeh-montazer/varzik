        ...
        <div className='flex flex-col justify-center items-center '>
            ...
            <div className='flex flex-col  absolute top-20 right-18'>
                ...
                <div className='flex  flex-col mb-6 justify-center items-center'>
                    <div >
                        <button className='hover:bg-gradient-to-r from-purple-500 to-pink-500 w-44 h-10 border border-x-4 rounded-full  mb-3'>کاهش وزن و تناسب اندام</button>

                    </div>

                    <div>
                        <button className='hover:bg-gradient-to-r from-purple-500 to-pink-500 w-44 h-10 border border-x-4 rounded-full mb-3'>عضله‌سازی و قدرت</button>

                    </div>

                    <div>
                        <button className='hover:bg-gradient-to-r from-purple-500 to-pink-500 w-44 h-10 border border-x-4 rounded-full mb-3'>فیتنس فانکشنال</button>

                    </div>

                    <div>
                        <button className='hover:bg-gradient-to-r from-purple-500 to-pink-500 w-44 h-10 border border-x-4 rounded-full mb-3'>بهبود عملکرد ورزشی</button>
